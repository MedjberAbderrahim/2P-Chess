import { cellValue } from "./structs.js";
import { sides } from "./index.js";
import { isCheck } from "./procs.js";
export function verifyIfCheckAfterMove(board, fromIndex, toIndex, sideToVerifyCheckFor) {
    let tmpValue;
    let result;
...
function getLegalMovesPawn(board, cellIndex) {
    let result = new Set();
...
function getLegalMovesKnight(board, cellIndex) {
    let result = new Set();
...
function getLegalMovesBishop(board, cellIndex) {
    let result = new Set();
...
function getLegalMovesRook(board, cellIndex) {
    let result = new Set();
...
function getLegalMovesQueen(board, cellIndex) {
    return new Set([...getLegalMovesBishop(board, cellIndex), ...getLegalMovesRook(board, cellIndex)]);
}
function getLegalMovesKing(board, cellIndex) {
    let result = new Set();
...
export function isLegal(board, fromIndex, toIndex) {
